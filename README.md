...
4. Repeat step 4 with your KH2Randomizer.exe (seed generator).
5. Repeat step 4 with your OpenKh.Tools.ModsManager.exe (mods manager)
6. Repeat step 4 with build_from_mm.exe.
7. Repeat step 4 with Livesplit
8. Repeat step 4 with Epic Games.
9. That's it! Save the file and test that it works by double clicking it!
